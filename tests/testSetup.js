async function setupDB(appDataSource) {
  ...
  await appDataSource.query(`
    INSERT INTO admin (id, admin_id, password) VALUES(1, 'admin1108','$2b$10$tk4j7zQuPFTXSCK5rQkc.O13fLI7wARDFqoqkXtlE3gxpt4FvaM/C');
  `);
...
async function resetDB(appDataSource) {
  ...
  await appDataSource.query(`TRUNCATE TABLE admin;`);
